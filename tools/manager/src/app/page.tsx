          ...
          {!currentWs ? (
            <p className="text-slate-400">Select a workshop to edit.</p>
             ...
             <div className="space-y-6">
              {/* ── Category 1: Workshop Level Input ──────────────────────────────── */}
              <div className="border border-slate-700 rounded-lg overflow-hidden bg-slate-800 shadow-md">
                <button
                  onClick={() => setOpenSections(prev => ({ ...prev, workshopLevel: !prev.workshopLevel }))}
                  className="w-full flex justify-between items-center bg-slate-700/50 hover:bg-slate-700/80 px-6 py-4 transition-colors select-none text-left"
                >
                  <h2 className="text-xl font-bold text-sky-400">Workshop Level Input</h2>
                  <span className="text-slate-400 text-lg transition-transform duration-200">
                    {openSections.workshopLevel ? '▼' : '▶'}
                  </span>
                </button>
                {openSections.workshopLevel && (
                  <div className="p-6 border-t border-slate-700/60 bg-slate-800/40 grid grid-cols-2 gap-4">
              ...
              <div className="border border-slate-700 rounded-lg overflow-hidden bg-slate-800 shadow-md">
                <button
                  onClick={() => setOpenSections(prev => ({ ...prev, host: !prev.host }))}
                  className="w-full flex justify-between items-center bg-slate-700/50 hover:bg-slate-700/80 px-6 py-4 transition-colors select-none text-left"
                >
                  <h2 className="text-xl font-bold text-sky-400">Workshop Host</h2>
                  <span className="text-slate-400 text-lg transition-transform duration-200">
                    {openSections.host ? '▼' : '▶'}
                  </span>
                </button>
                {openSections.host && (
                  <div className="p-6 border-t border-slate-700/60 bg-slate-800/40">
                    <HostManager 
              ...
              {/* ── Category 2: Corporate Sponsors ──────────────────────────────── */}
              <div className="border border-slate-700 rounded-lg overflow-hidden bg-slate-800 shadow-md">
                <button
                  onClick={() => setOpenSections(prev => ({ ...prev, sponsors: !prev.sponsors }))}
                  className="w-full flex justify-between items-center bg-slate-700/50 hover:bg-slate-700/80 px-6 py-4 transition-colors select-none text-left"
                >
                  <h2 className="text-xl font-bold text-sky-400">Corporate Sponsors</h2>
                  <span className="text-slate-400 text-lg transition-transform duration-200">
              ...
              {/* ── Category 3: Itinerary Events ────────────────────────────────── */}
              <div className="border border-slate-700 rounded-lg overflow-hidden bg-slate-800 shadow-md">
                <button
                  onClick={() => setOpenSections(prev => ({ ...prev, itinerary: !prev.itinerary }))}
                  className="w-full flex justify-between items-center bg-slate-700/50 hover:bg-slate-700/80 px-6 py-4 transition-colors select-none text-left"
                >
                  <h2 className="text-xl font-bold text-sky-400">Itinerary Events</h2>
                  <span className="text-slate-400 text-lg transition-transform duration-200">
              ...
              {/* ── Category 4: Oral Presentations ──────────────────────────────── */}
              <div className="border border-slate-700 rounded-lg overflow-hidden bg-slate-800 shadow-md">
                <button
                  onClick={() => setOpenSections(prev => ({ ...prev, presentations: !prev.presentations }))}
                  className="w-full flex justify-between items-center bg-slate-700/50 hover:bg-slate-700/80 px-6 py-4 transition-colors select-none text-left"
                >
                  <h2 className="text-xl font-bold text-sky-400">Oral Presentations</h2>
                  <span className="text-slate-400 text-lg transition-transform duration-200">
              ...
              <div className="border border-slate-700 rounded-lg overflow-hidden bg-slate-800 shadow-md">
                <button
                  onClick={() => setOpenSections(prev => ({ ...prev, studentAwards: !prev.studentAwards }))}
                  className="w-full flex justify-between items-center bg-slate-700/50 hover:bg-slate-700/80 px-6 py-4 transition-colors select-none text-left"
                >
                  <h2 className="text-xl font-bold text-sky-400">Student Awards</h2>
                  <span className="text-slate-400 text-lg transition-transform duration-200">
                    {openSections.studentAwards ? '▼' : '▶'}
                  </span>
                </button>
                {openSections.studentAwards && (
                  <div className="p-6 border-t border-slate-700/60 bg-slate-800/40">
              ...
              <div className="border border-slate-700 rounded-lg overflow-hidden bg-slate-800 shadow-md">
                <button
                  onClick={() => setOpenSections(prev => ({ ...prev, posters: !prev.posters }))}
                  className="w-full flex justify-between items-center bg-slate-700/50 hover:bg-slate-700/80 px-6 py-4 transition-colors select-none text-left"
                >
                  <h2 className="text-xl font-bold text-sky-400">Posters</h2>
                  <span className="text-slate-400 text-lg transition-transform duration-200">
                    {openSections.posters ? '▼' : '▶'}
                  </span>
                </button>
                {openSections.posters && (
                  <div className="p-6 border-t border-slate-700/60 bg-slate-800/40">
