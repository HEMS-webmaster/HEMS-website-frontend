import { GraduationCap, Award, Calendar, Mail, FileText, CheckCircle2 } from "lucide-react";
  ...
  return (
    <>
      ...
      <header className="mb-12 border-b border-foreground/10 pb-8">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-2">Student Travel Awards</h1>
        <p className="text-foreground/70">Supporting the next generation of researchers building analytical instrumentation for extreme and harsh environments.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <section className="bg-background border border-foreground/10 rounded-lg p-6 shadow-sm">
            <h2 className="text-lg font-bold text-foreground mb-4">Program Overview</h2>
            ...
            <div className="bg-surface/10 border border-foreground/10 rounded-xl p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
              <div>
                <span className="text-[10px] uppercase font-mono text-foreground/50 block">Award Amount</span>
                <span className="text-2xl font-mono font-bold text-primary">$1,500.00</span>
              </div>
              <div className="text-right sm:text-left border-t sm:border-t-0 sm:border-l border-foreground/10 pt-4 sm:pt-0 sm:pl-6 flex-grow">
                <span className="text-[10px] uppercase font-mono text-foreground/50 block">Usage</span>
                <p className="text-xs text-foreground/75">Covers lodging, transportation, and workshop registration fees.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-background border border-foreground/10 rounded-lg p-6 shadow-sm space-y-6">
            <h2 className="text-lg font-bold text-foreground flex items-center gap-2">
              <FileText className="text-primary" size={20} /> Application Guidelines
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="border border-foreground/10 p-4 rounded-lg bg-surface/5 hover:border-primary/30 transition-colors">
                <span className="text-primary font-mono text-sm font-bold block mb-1">01. Student Letter</span>
              ...
              <div className="border border-foreground/10 p-4 rounded-lg bg-surface/5 hover:border-primary/30 transition-colors">
                <span className="text-primary font-mono text-sm font-bold block mb-1">02. Recommendation Letter</span>
                <p className="text-xs text-foreground/70 leading-relaxed">
              ...
              <div className="border border-foreground/10 p-4 rounded-lg bg-surface/5 hover:border-primary/30 transition-colors">
                <span className="text-primary font-mono text-sm font-bold block mb-1">03. Abstract & Title</span>
                <p className="text-xs text-foreground/70 leading-relaxed">
              ...
              <div className="border border-foreground/10 p-4 rounded-lg bg-surface/5 hover:border-primary/30 transition-colors">
                <span className="text-primary font-mono text-sm font-bold block mb-1">04. Curriculum Vitae</span>
                <p className="text-xs text-foreground/70 leading-relaxed">
          ...
          {/* Criteria */}
          <section className="bg-background border border-foreground/10 rounded-lg p-6 shadow-sm">
            <h2 className="text-lg font-bold text-foreground mb-4">Selection Criteria</h2>
            <ul className="space-y-3">
              {[
                ...
                <li key={idx} className="flex gap-2.5 items-start text-xs text-foreground/80">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-background border border-foreground/10 p-6 rounded-xl shadow-sm">
            <h3 className="font-bold uppercase tracking-wider text-xs mb-3 border-b border-foreground/10 pb-2">
              Eligibility
            </h3>
            <p className="text-xs text-foreground/70 leading-relaxed">
          ...
          <div className="bg-background border border-foreground/10 p-6 rounded-xl shadow-sm">
            ...
            <div className="text-xl font-mono font-bold text-foreground mb-1">AUGUST 8, 2025</div>
            <span className="inline-block bg-secondary/15 text-secondary text-[10px] font-bold px-2 py-0.5 rounded">
              EXTENDED DEADLINE
            </span>
          </div>
          ...
          <div className="bg-primary text-background rounded-xl p-6 shadow-md flex flex-col justify-between">
            <div>
              <h3 className="font-bold uppercase tracking-wider text-xs mb-2 opacity-95">How to Submit</h3>
